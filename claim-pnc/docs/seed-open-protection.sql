...
INSERT INTO POOLDATA.T_CLAIM_OPENPROTECTION
  (ID, CREATE_DATE, CREATED_BY, POLICY_NO, CLAIM_NO, ID_CLAIM,
   PROTECTION_TYPE, NOTES, OBJECT_NAME, BRANCH_NAME, STATUS_ACTIVE)
VALUES
  ('OPCN.26.0001', SYS_EXTRACT_UTC(SYSTIMESTAMP), 'UJICOBA01',
   'UJI-POLIS-0001', 'PNCN.26.9001', 'ASM-FW-GCNMFW-WORK PNCN.26.9001',
...
INSERT INTO POOLDATA.T_CLAIM_OPENPROTECTION
  (ID, CREATE_DATE, CREATED_BY, POLICY_NO, CLAIM_NO, ID_CLAIM,
   PROTECTION_TYPE, NOTES, OLD_DATA, NEW_DATA, OBJECT_NAME, BRANCH_NAME, STATUS_ACTIVE)
VALUES
  ('OPCN.26.0002', SYS_EXTRACT_UTC(SYSTIMESTAMP), 'UJICOBA01',
   'UJI-POLIS-0002', 'PNCN.26.9002', 'ASM-FW-GCNMFW-WORK PNCN.26.9002',
...
VALUES
  ('OPCN.26.0003', SYS_EXTRACT_UTC(SYSTIMESTAMP), 'UJICOBA02',
   'UJI-POLIS-0003', 'PNCN.26.9003', 'ASM-FW-GCNMFW-WORK PNCN.26.9003',
...
VALUES
  ('OPCN.26.0004', SYS_EXTRACT_UTC(SYSTIMESTAMP), 'UJICOBA02',
   'UJI-POLIS-0004', 'PNCN.26.9004', 'ASM-FW-GCNMFW-WORK PNCN.26.9004',
...
INSERT INTO POOLDATA.T_CLAIM_OPENPROTECTION
  (ID, CREATE_DATE, CREATED_BY, POLICY_NO,
   PROTECTION_TYPE, NOTES, OBJECT_NAME, BRANCH_NAME, STATUS_ACTIVE)
VALUES
...
-- tertulis.
INSERT INTO POOLDATA.T_CLAIM_OPENPROTECTION
  (ID, CREATE_DATE, CREATED_BY, CLAIM_NO, ID_CLAIM,
   PROTECTION_TYPE, NOTES, OBJECT_NAME, BRANCH_NAME, STATUS_ACTIVE)
VALUES
  ('OPCN.26.0006', SYS_EXTRACT_UTC(SYSTIMESTAMP), 'UJICOBA02',
   'PNCN.26.9006', 'ASM-FW-GCNMFW-WORK PNCN.26.9006',
...
INSERT INTO POOLDATA.T_CLAIM_OPENPROTECTION
  (ID, CREATE_DATE, CREATED_BY, POLICY_NO, CLAIM_NO, ID_CLAIM,
   PROTECTION_TYPE, NOTES, APPROVAL_STATUS, RESOLVED_BY, RESOLVED_DATE_TIME,
   OBJECT_NAME, BRANCH_NAME, STATUS_ACTIVE)
VALUES
  ('OPCN.26.0007', SYS_EXTRACT_UTC(SYSTIMESTAMP) - INTERVAL '2' DAY, 'UJICOBA01',
   'UJI-POLIS-0007', 'PNCN.26.9007', 'ASM-FW-GCNMFW-WORK PNCN.26.9007',
...
VALUES
  ('OPCN.26.0008', SYS_EXTRACT_UTC(SYSTIMESTAMP) - INTERVAL '3' DAY, 'UJICOBA02',
   'UJI-POLIS-0008', 'PNCN.26.9008', 'ASM-FW-GCNMFW-WORK PNCN.26.9008',
...
VALUES
  ('OPCN.26.0009', SYS_EXTRACT_UTC(SYSTIMESTAMP), 'UJICOBA01',
   'UJI-POLIS-0009', 'PNCN.26.9009', 'ASM-FW-GCNMFW-WORK PNCN.26.9009',
...
VALUES
  ('OPCN.26.0010', SYS_EXTRACT_UTC(SYSTIMESTAMP) - INTERVAL '30' DAY, 'UJICOBA01',
   'UJI-POLIS-0001', 'PNCN.26.9010', 'ASM-FW-GCNMFW-WORK PNCN.26.9010',
...
SELECT COUNT(*) AS non_premi
 ...
 WHERE APPROVAL_STATUS IS NULL
   AND CLAIM_NO IS NOT NULL AND POLICY_NO IS NOT NULL
   AND (STATUS_ACTIVE IS NULL OR TRIM(STATUS_ACTIVE) = '1')
   AND (PROTECTION_TYPE IS NULL OR TRIM(PROTECTION_TYPE) <> '2');
...
--
-- DELETE FROM POOLDATA.T_CLAIM_OPENPROTECTION WHERE ID LIKE 'OPCN.26.00%';
-- COMMIT;
