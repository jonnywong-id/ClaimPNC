...
-- masterrekening.PangkasResponsKasir.

-- name: rekening_daftar
SELECT ACCOUNT_NO,
       ACCOUNT_NAME,
       BANK_NAME,
       BANK_BRANCH,
...
-- Alasannya mengikat seluruh aplikasi: waktu berasal dari satu seam (platform/waktu)
...
-- name: rekening_hapus_yang_ditolak
