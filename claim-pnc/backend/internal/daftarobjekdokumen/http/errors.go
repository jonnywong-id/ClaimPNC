...
//
// Nilainya sengaja SAMA PERSIS dengan modul Master COL Simas Online, bukan dikarang sendiri:
// klien sudah mengenali ketiganya, dan kode galat baru untuk arti yang sama hanya menambah
// cabang di frontend tanpa menambah keterangan apa pun.
//
...
func mapError(err error) (int, ErrorResponse, bool) {
	...
	case errors.Is(err, daftarobjekdokumen.ErrNotFound):
		return http.StatusNotFound, ErrorResponse{
			Code:    CodeNotFound,
			Message: "Objek dokumen yang dimaksud tidak ditemukan. Mungkin sudah diubah petugas lain — muat ulang daftarnya.",
		}, true
