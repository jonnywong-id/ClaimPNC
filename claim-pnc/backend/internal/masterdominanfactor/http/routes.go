...
// Mount mendaftarkan seluruh rute modul Master Dominan Factor ke router yang diberikan.
//
...
// seluruhnya berbagi satu menu serta satu kewenangan. Mengelompokkannya membuat
// penegakan izin per menu (`D-59`) dapat dipasang pada satu tempat.
//
// Ruasnya `dominan-factor`, bukan `faktor-dominan`: itulah nama modul yang dipakai Work
// Owner dan yang tertulis di butir menu MENU_ID 18 (`D-81`).
//
// # Kewenangan
//
