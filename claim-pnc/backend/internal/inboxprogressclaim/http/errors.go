...
func mapError(err error) (int, ErrorResponse, bool) {
	...
	case errors.Is(err, inboxprogressclaim.ErrCallerUnknown):
		...
		return http.StatusConflict, ErrorResponse{
			...
			Message: "Identitas Anda tidak terbaca, sehingga rekap milik Anda tidak " +
				"dapat dipisahkan dari rekap petugas lain. Masuk ulang lalu coba lagi.",
		}, true
