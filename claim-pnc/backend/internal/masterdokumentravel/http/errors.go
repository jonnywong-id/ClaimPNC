...
const (
	CodeNotFound         = "dokumen_travel_tidak_ditemukan"
...
func mapError(err error) (int, ErrorResponse, bool) {
	switch {
	case errors.Is(err, masterdokumentravel.ErrNotFound):
		return http.StatusNotFound, ErrorResponse{
			Code:    CodeNotFound,
			Message: "Dokumen travel yang dimaksud tidak ditemukan. Mungkin sudah diubah petugas lain — muat ulang daftarnya.",
		}, true
