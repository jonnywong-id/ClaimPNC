...
func mapError(err error) (int, ErrorResponse, bool) {
	...
	case errors.Is(err, inboxclaimtreatyprop.ErrCallerUnknown):
	...
	case errors.Is(err, inboxclaimtreatyprop.ErrWriteNotAvailable):
		...
		return http.StatusNotImplemented, ErrorResponse{
			...
			Message: "Pembuatan klaim treaty belum tersedia di sistem baru. Selama Pega " +
				"dan sistem baru berjalan berdampingan, tabel klaim hanya boleh ditulis " +
				"satu sistem, dan tabel itu masih dimiliki Pega. Buat klaim treaty baru " +
				"lewat Pega.",
		}, true
