...
// tinggal memakainya.
const (
	CodeNotFound         = "detail_dokumen_travel_tidak_ditemukan"
...
func mapError(err error) (int, ErrorResponse, bool) {
	switch {
	case errors.Is(err, daftardetaildokumentravel.ErrNotFound):
		return http.StatusNotFound, ErrorResponse{
			Code:    CodeNotFound,
			Message: "Detail dokumen travel yang dimaksud tidak ditemukan. Mungkin sudah diubah petugas lain — muat ulang daftarnya.",
		}, true
