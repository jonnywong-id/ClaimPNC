...
// Galat domain modul Inbox Claim Treaty Non Prop.
//
...
var (
	...
	//
	// Ia bukan sekadar ketidaknyamanan: tab Admin menyaring menurut login pemanggil,
	...
	ErrCallerUnknown = errors.New(
		"inboxclaimtreatynonprop: identitas pemanggil tidak terbaca")

	// ErrWriteNotAvailable berarti aksi tulis diminta pada modul yang hanya membaca.
	//
	// Ia ADA supaya tombol "Create Claim Treaty Non Prop" dapat dijawab dengan alasan
	// alih-alih dengan "halaman tidak ditemukan" — dua hal yang terlihat sangat berbeda
	// bagi pengguna, dan hanya yang pertama yang memberi tahu apa yang harus dilakukannya.
	ErrWriteNotAvailable = errors.New(
		"inboxclaimtreatynonprop: modul ini belum menulis apa pun")
)
...
func (e *ValidationError) Error() string {
	if len(e.Violations) == 0 {
		return "inboxclaimtreatynonprop: isian tidak sah"
	}
	...
	return "inboxclaimtreatynonprop: " + strings.Join(parts, "; ")
}
