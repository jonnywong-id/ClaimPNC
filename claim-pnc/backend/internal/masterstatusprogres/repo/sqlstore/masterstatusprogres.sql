...
-- name: progress_status_list_id_locked
--
...
-- yang sama diturunkan — bentuk nomornya tetap sama (masterstatusprogres.FormatNomor).
SELECT ID_PROGRESS
  FROM POOLDATA.GCNM_MST_PROGRESS_KLAIM
 FOR UPDATE

-- name: progress_status_insert
--
...
--
-- TRIM pada penyaringnya sama alasannya dengan progress_status_get: kolomnya CHAR
...
-- name: progress_status_check_table
--
