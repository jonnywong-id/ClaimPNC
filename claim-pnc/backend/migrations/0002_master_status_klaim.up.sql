...
-- masterstatus.KunciLabel di kode Go — bila keduanya berbeda, aplikasi akan menerima
...
-- internal/masterstatus/repo/sqlstore/statusklaim.go). Mengganti namanya di sini tanpa
