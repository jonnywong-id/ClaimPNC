...
export const MENU_ROUTES: Record<string, string> = {
  ...
  //
  // Dua butir lain milik cabang yang di-merge — `PNCInboxAdmin` (63) dan
  // `PNCSearchKlaim` (76) — SENGAJA tidak dipetakan di sini. Kedua modulnya ada di repo,
  // tetapi cabang ini tidak memasang satu pun rute API-nya di `cmd/claimpnc`, sehingga
  // memetakannya berarti menghidupkan butir menu yang mengantar pengguna ke layar tanpa
  // backend. Menyalakannya menuntut perakitan kedua modul itu lebih dulu — keputusan
  // tersendiri, bukan bagian dari merge ini.
